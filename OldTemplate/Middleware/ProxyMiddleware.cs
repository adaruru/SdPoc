        ...
        private Uri BuildTargetUri(HttpRequest request)
        {
            ...
            switch (true)
            {
                ...
                case true when request.Path.StartsWithSegments("/Ap1", out var remainingPath):
                    targetUri = new Uri("https://localhost:11443/ServiceA" + remainingPath);
                    break;
                case true when request.Path.StartsWithSegments("/Ap2", out var remainingPath):
                    targetUri = new Uri("https://localhost:22443/ServiceA" + remainingPath);
                    break;
                default:
                    targetUri = new Uri("https://localhost:22443/ServiceA");
                    break;
            }
